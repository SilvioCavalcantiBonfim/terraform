...
Este repositório contém código Terraform para criar uma Virtual Network (VNET) no Microsoft Azure com o armazenamento do `remote state` em um Azure Container Storage.
